...
#             s+='    z"Hub": {} - u"Hub": {} (NOTE: values at TurbSim "hub")\n'.format(zMid, uMid)
    ...
    def toDataset(self):
        ...
        print('[TODO] pyFAST.io.turbsim_file.toDataset: merge with function toDataSet')
    ...
    def toDataSet(self, datetime=False):
        ...
        print('[TODO] pyFAST.io.turbsim_file.toDataSet: should be discontinued')        
        print('[TODO] pyFAST.io.turbsim_file.toDataSet: merge with function toDataset')        
    ...
    def fromAMRWind(self, filename, timestep, output_frequency, sampling_identifier, verbose=1, fileout=None, zref=None, xloc=None):
        ...
        """
        try:
            from pyFAST.io.amrwind_file import AMRWindFile
        except:
            try:
