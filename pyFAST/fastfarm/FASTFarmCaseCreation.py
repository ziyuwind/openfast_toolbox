...
from pyFAST.io import FASTInputFile, FASTOutputFile, TurbSimFile, VTKFile
...
class FFCaseCreation:
    ...
    def TS_low_setup(self, writeFiles=True, runOnce=False):
        # Loops on all conditions/seeds creating Low-res TurbSim box  (following pyFAST/pyFAST/fastfarm/examples/Ex1_TurbSimInputSetup.py)
